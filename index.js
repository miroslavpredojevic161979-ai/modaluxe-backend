...
app.get('/brisanje-baze', async (req, res) => {
  try {
    ...
    res.send('<h1>Sve narudžbe i ulazni računi su uspješno obrisani! đź§ą</h1><p>Sada se vrati u VS Code, OBRISI ovaj kod i ponovno stisni Sync Changes kako ti nitko drugi ne bi mogao obrisati bazu.</p>');
  } catch (err) { 
